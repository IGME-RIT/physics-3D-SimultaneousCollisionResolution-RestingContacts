...
PipeWire::PipeWire(VkDevice dev, VkDescriptorSetLayout desc_layout, VkRenderPass render_pass)
{
	device = dev;
	...
	VkPipelineVertexInputStateCreateInfo vi = VertexWire::GetState();
