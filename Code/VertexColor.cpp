...
// two attributes
static VkVertexInputAttributeDescription vertexInputAttributs[2];
...
VkPipelineVertexInputStateCreateInfo VertexColor::GetState()
{
	...
	vertexInputBinding.stride = sizeof(VertexColor);
	...
	// format is same as position, becuase there are three floats.
